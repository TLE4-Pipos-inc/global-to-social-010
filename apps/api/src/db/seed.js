...
import { conversationStarters, interests, users, venues } from "./schema.js"
...
const venueSeedData = [
  {
    ...
    description: "Calm coffee spot near Blaak for first meetups and quiet chats.",
    latitude: 51.92015,
    longitude: 4.48941,
  ...
  },
  {
    ...
    description: "Food-focused stop with easy conversation around shared bites.",
    latitude: 51.92001,
    longitude: 4.48666,
...
const starterSeedData = [
  ...
  [null, "general", "Do you prefer calm conversations or energetic group activities?", 30],
  ...
  [null, "general", "What's one thing you always notice when you enter a new place?", 0],
  [null, "general", "Are you more of a planner or a spontaneous person?", 5],
  [null, "general", "What's a small thing that can instantly improve your day?", 10],
  [null, "general", "What's your favorite way to spend time with friends?", 15],
  [null, "general", "Do you prefer meeting people one-on-one or in groups?", 20],
  [null, "general", "What's something new you tried recently?", 25],
  [null, "general", "What's a place in the city you think everyone should visit?", 30],
  [null, "general", "What's the best recommendation someone gave you lately?", 35],
  [null, "general", "What kind of atmosphere makes you feel most comfortable?", 40],
  ...
  [null, "general", "What's one thing people are usually surprised to learn about you?", 10],
  [null, "general", "What's your favorite way to relax after a long day?", 15],
  [null, "general", "What's the most interesting conversation you've had recently?", 20],
  [null, "general", "If you could invite anyone to join this table, who would it be?", 25],
  ...
  [null, "general", "What's a simple question that always starts a good conversation?", 40],
  ...
  ["Music", "music", "If you could create the perfect festival lineup, who's headlining?", 20],
  ...
  ["Food", "food", "If you could only eat one cuisine for a month, what would it be?", 15],
  ...
  ["Sports", "sports", "What's one country you'd move to for a year?", 20],
  ...
  ["Gaming", "gaming", "Are you more into multiplayer or single-player games?", 5],
  ...
  ["Culture", "culture", "Is there a tradition from another country you'd love to experience?", 0],
  ["Culture", "culture", "What's a cultural event everyone should attend once?", 5],
  ["Culture", "culture", "Have you ever celebrated a holiday from another culture?", 10],
  ...
  ["Languages", "languages", "What's your favorite word in another language?", 5],
  ["Languages", "languages", "Have you ever had a funny translation mistake?", 10],
  ["Languages", "languages", "Which language sounds the most beautiful to you?", 15],
  ["Languages", "languages", "Do you use language-learning apps or prefer real conversations?", 20],
  ...
  ["Nightlife", "nightlife", "Are you the planner or the spontaneous friend?", 20],
  ["Quiet chats", "quiet-chats", "What's something you've been thinking about lately?", 0],
  ["Quiet chats", "quiet-chats", "What's a small thing that always makes your day better?", 5],
  ["Quiet chats", "quiet-chats", "Morning person or night owl?", 10],
  ["Quiet chats", "quiet-chats", "What's a hobby you wish you had more time for?", 15],
  ["Quiet chats", "quiet-chats", "What's the best conversation you've ever had?", 20],
  ["Theme parks", "theme-parks", "Roller coaster or water rides?", 0],
  ["Theme parks", "theme-parks", "What's the best theme park you've visited?", 5],
  ["Theme parks", "theme-parks", "Do you go for the rides or the snacks?", 10],
  ["Theme parks", "theme-parks", "Which fictional world deserves its own theme park?", 15],
  ["Theme parks", "theme-parks", "What's the ride you'll always go on twice?", 20],
  ["Photography", "photography", "What's your favorite thing to photograph?", 0],
  ["Photography", "photography", "Phone camera or dedicated camera?", 5],
  ["Photography", "photography", "Sunrise or sunset photos?", 10],
  ["Photography", "photography", "What's the best photo you've ever taken?", 15],
  ["Photography", "photography", "If you could photograph anywhere in the world, where would you go?", 20],
  ...
  ["Reading", "reading", "What's your favorite book that makes a place in the 20th century?", 0],
  ...
  ["Art & Design", "art-design", "What's the coolest piece of art you've seen in person?", 0],
  ["Art & Design", "art-design", "Which artist inspires you the most?", 5],
  ["Art & Design", "art-design", "If you could decorate a room any way you wanted, what would it look like?", 10],
  ["Art & Design", "art-design", "Is there a creative project you would love to start?", 15],
  ["Art & Design", "art-design", "What's a place that gave you a lot of creative inspiration?", 20],
  ["Fitness & Gym", "fitness-gym", "What's your favorite workout and why is it legs?", 0],
  ["Fitness & Gym", "fitness-gym", "What's a fitness goal you're working on, and why?", 5],
  ["Fitness & Gym", "fitness-gym", "Morning gym or evening gym?", 10],
  ["Fitness & Gym", "fitness-gym", "What is your bench PR? Okay, now what is your real bench PR?", 15],
  ["Fitness & Gym", "fitness-gym", "What's the best post-workout snack?", 20],
  ["Karaoke", "karaoke", "What's your favorite karaoke song?", 0],
  ["Karaoke", "karaoke", "How many drinks until you get less awkward at singing?", 5],
  ["Karaoke", "karaoke", "What's a song you would never dare to sing in public?", 10],
  ["Karaoke", "karaoke", "Solo karaoke or group sing-along?", 15],
  ["Karaoke", "karaoke", "Who do you think you sing like?", 20],
  ["Beach days", "beach-days", "If you could plan a beach day with friends, what would you do first?", 0],
  ["Beach days", "beach-days", "Someone says that going to the pool is better than going to the beach. What do you say?", 5],
  ["Beach days", "beach-days", "Swimming or relaxing in the sand?", 10],
  ["Beach days", "beach-days", "What's your ideal beach snack?", 15],
  ["Beach days", "beach-days", "Would you rather go on a walk or go on a run?", 20],
  ["Museums", "museums", "What's your favorite type of museum?", 0],
  ["Museums", "museums", "Which museum is on your bucket list?", 5],
  ["Museums", "museums", "Have you ever spent long looking at one exhibit and why?", 10],
  ["Museums", "museums", "History, science or modern art?", 15],
  ["Museums", "museums", "What museum would you recommend to someone visiting your city? And why that one?", 20],
  ["Fashion", "fashion", "You have EUR 200 to spend, what outfit would you create?", 0],
  ...
  ["Fashion", "fashion", "If you could swap wardrobes with anyone for a day, who would it be?", 20],
  ["Nature", "nature", "What's your favorite outdoor activity?", 0],
  ["Nature", "nature", "Have you ever seen a breathtaking natural view? And where?", 5],
  ["Nature", "nature", "What's your perfect weather for being outside?", 10],
  ["Nature", "nature", "If you could spend a week in nature anywhere, where would you go?", 15],
  ...
  ["Animals", "animals", "Have you ever volunteered or worked with animals?", 10],
  ["Animals", "animals", "What's an animal fact that surprises people?", 15],
  ["Animals", "animals", "If you could have any animal as a pet, what would it be and why?", 20],
]
...
function seedVenues() {
  ...
  for (const venue of venueSeedData) {
    const existingVenue = db
      .select()
      .from(venues)
      .where(and(eq(venues.name, venue.name), eq(venues.address, venue.address)))
      .get()

    if (existingVenue) continue

    db.insert(venues).values({ id: uuidv4(), ...venue }).run()
    inserted += 1
  }
...
function getInterestIdsByName() {
  return new Map(db.select().from(interests).all().map((interest) => [interest.name, interest.id]))
}
...
function seedConversationStarters() {
  ...
  for (const [interestName, category, prompt, triggerMinute] of starterSeedData) {
    const interestsId = interestName ? interestIdsByName.get(interestName) : null

    if (interestName && !interestsId) {
      console.warn(`Skipped starter "${prompt}": missing interest ${interestName}`)
      continue
    }
